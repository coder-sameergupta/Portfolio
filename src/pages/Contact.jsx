...
const contactLinks = [
  ...
  { icon: 'LI', label: 'LinkedIn', value: 'https://www.linkedin.com/in/sameer-gupta-02749828a/', href: 'https://www.linkedin.com/in/sameer-gupta-02749828a/', accent: 'var(--accent-blue)' },
